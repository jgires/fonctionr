...
tableau_recap <- tibble::tribble(
   ~`Catégorie d’argument`,    ~prop_group,  ~many_val_group,       ~many_val, ~central_group, ~distrib_group_d,     ~distrib_d,   ~distrib_group_c,         ~distrib_c,
     ...
     "Esthétique: labels",             "",  "list_vars_lab", "list_vars_lab",             "",               "",             "",                 "",                 "",
           "indispensable",             "",           "type",          "type",         "type",               "",             "",             "type",             "type",
            "argument clé",        "facet",          "facet",         "facet",        "facet",          "facet",        "facet", "en developpement", "en developpement",
         ...
         "Base de données",            "…",              "…",             "…",            "…",              "…",            "…",                "…",                 "",
            ...
            "argument clé",  "na.rm.facet",    "na.rm.facet",   "na.rm.facet",  "na.rm.facet",    "na.rm.facet",  "na.rm.facet", "en developpement", "en developpement",
      ...
      "Esthétique de base",     "show_lab",       "show_lab",      "show_lab",     "show_lab",       "show_lab",     "show_lab",         "show_lab",         "show_lab",
      "Esthétique de base",   "total_name",               "",              "",   "total_name",               "",             "",                 "",                 "",
  ...
  "Esthétique: graphique",         "fill",               "",              "",         "fill",               "",         "fill",                 "",                 "",
  "Esthétique: graphique",             "",            "pal",           "pal",             "",            "pal",             "",              "pal",              "pal",
  "Esthétique: graphique",             "",      "direction",     "direction",             "",      "direction",             "",                 "",                 "",
  ...
  "Esthétique: graphique",        "dodge",          "dodge",         "dodge",        "dodge",          "dodge",        "dodge",                 "",                 "",
   "Esthétiques: lettres",         "font",           "font",          "font",         "font",           "font",         "font",             "font",             "font",
   "Esthétiques: lettres", "wrap_width_y",   "wrap_width_y",  "wrap_width_y", "wrap_width_y",   "wrap_width_y", "wrap_width_y",     "wrap_width_y",                 "",
   "Esthétiques: lettres",             "", "wrap_width_leg",              "",             "", "wrap_width_leg",             "",                 "",                 "",
   "Esthétiques: lettres",             "",    "legend_ncol",              "",             "",    "legend_ncol",             "",                 "",                 "",
     ...
     "Esthétique: labels",             "",     "legend_lab",              "",             "",     "legend_lab",             "",                 "",                 "",
