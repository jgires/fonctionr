...
Dans les graphiques monochrome, `pal` peut prendre la valeur d'une couleur de base de R ou d'un code couleur hexadécimal. C'est le cas pour `distrib_discrete()`, `prop_group()` et `central_group()` quand il n'y a pas d'argument `group.fill`.
