...
Pour des raisons pédagogiques, les arguments sont abordés successivement par types : la base de données, les arguments indispensables, les arguments ayant une influence sur les calculs, les arguments esthétiques,
