...
-   Le graphique "graph" permet une visualisation facile et directement utilisable dans une publication de la distribution des fréquences avec des intervalle de confiance.
...
## distrib_discrete() pour décrire la distribution d'une variable qualitative selon des groupes (une autre variable qualitative)
