...
tableau_recap <- tibble::tribble(
  ...
  "Esthétique: graphique",    1L,      "string",          "theme",                   "theme",                   "theme",          "theme",                   "theme",                      "theme",          "theme",                   "theme","Esthétique: graphique",    1L,      "coef_font",        "coef_font",                 "coef_font",                 "coef_font",        "coef_font",                 "coef_font",                    "coef_font",        "coef_font",                 "coef_font",
