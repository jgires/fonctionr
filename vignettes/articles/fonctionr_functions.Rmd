...
L'objectif de `fonctionr` est de faciliter l'analyse de données issues de sondages complexes, dont la manipulation est parfois laborieuse. `fonctionr` a été développé dans l'idée de réduire la taille du code à écrire pour produire les résulats descriptifs et d'analyses bivariées les plus courants.
