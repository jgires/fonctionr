...
distrib_income$dens
distrib_income$tab
distrib_income$quant
distrib_income$moustache
```
...
-   `bw`
-   Certains arguments sont spécifiques aux fonctions distrib_continous() et distrib_group_continous(). C'est notamment le cas de bw qui indique le degré de "lissage" de la densité. Une valeur plus élevée conduira à plus lisser la densité et masquera davantages les variations locales alors qu'une valeur plus faible montrera les détails dans la variations de le courbe, même s'ils ne sont pas statistiquement significatifs.
-    `resolution`
