...
-   Amélioration de l'affichage des aires de densité dans `distrib_group_continuous()` lorsque la palette est d'une seule couleur (on en voit plus les limites des quantiles).
