...
-   **(Joël) Le code a été simplifié pour toutes les fonctions qui utilisaient `ggtext` (suivant la logique ici : <https://github.com/wilkelab/ggtext/issues/121>), faire pareil pour les fonctions qui ne l'utilisaient pas (pour groupe *NA* en italique).**
