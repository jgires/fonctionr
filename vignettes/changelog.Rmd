...
-   Amélioration de l'affichage des aires de densité dans `distrib_group_continuous()` lorsque la couleur est d'une seule couleur (quantiles plus visibles).
-   Ajout des facets dans `make_surface()`.
-   Mise à la ligne automatique de caption tous les 100 caractères.
...
-   Ajouter la possibilité de reorder lors des facets =\> Ordre différent par facet ? Ou médiane comme les autres fonctions ?
