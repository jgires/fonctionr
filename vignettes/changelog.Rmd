...
-   Dans les checks : interdire le dégradé de couleur lorsque chevauchement des ridges (lorsque height \> 1). Le bug est lié à la manière dont les `geom_ribbon` sont positionnées sur le ggplot.
