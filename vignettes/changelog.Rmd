...
-   Modification des fonctions qui calculent des totaux, pour afficher le total et les indicateurs en gras. Pour ce faire, le package `ggtext` a été utilisé. Il y a donc une dépendance en plus.
...
-   L'utilisation de ggtext a été implémentée de manière un peu bricolée (comme un code en "surcouche"). Ca fonctionne, mais code largement simplifiable (idéal pour la lisibilité). Si on l'implémente de manière durable, à revoir.
