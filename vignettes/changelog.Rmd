...
-   Bug avec `color`, la ligne du geom_line est parfois coupée ?

-   Mal pensé : `pal_moustache` fonctionne comme `pal` et peut comprendre une couleur unie ou un vecteur de couleur. Mais logiquement, il n'est pas pertinent de représenter une moustache monochrome.
