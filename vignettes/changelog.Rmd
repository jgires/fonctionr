...
-   Correction d'un bug mineur dans l'ordonnancement par la médiane des résultats (la fonction est écrite avec des guillemets : `FUN = "median"`. Sans cela, il y avait dans certains cas particuliers un bug).
