...
-   **(Joël) Lorsqu'on rentre une palette soi même, elle est inversée dans certaines fonctions, alors que ce n'est pas le cas pour les palettes automatiques ???\
    =\> refaire le chemin de la génération des palettes.**
...
-   **(Joël) Le `NA` apparait en premier ?\
    =\> Corriger, il doit apparaître en dernier.**
