...
-   Ajouter le test stat univarié (en indiquant une H0)

-   Ajouter la panoplie de checks !
...
-   Interdire le dégradé de couleur lorsque chevauchement des ridges (lorsque height \> 1). Le bug est lié à la manière dont les `geom_ribbon` sont positionnées sur le ggplot.

-   Rendre possible le fait que le fill des ridges soit transparent (ajouter une condition pour faire le rendu des `geom_ribbon`).

-   Optimiser : ajouter des conditions pour éviter certains calculs inutiles selon les arguments.
