...
-   **(Joël) pour les test stat de prop_group et central_group, modifier le caption quand il y a des facets pour indiquer que le test se fait bien sur le total et ne pas faire le test quand il y a des facets et que total = FALSE.**
...
-   **(Joël) La moustache peut ne prendre qu'une couleur =\> pas cohérent\
    =\> Ajouter un check**
