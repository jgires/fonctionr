...
-   Ordonner les arguments de la même manière pour chaque fonction (voir fichier excel) =\> **faire pareil pour l'ordre des arguments dans les fonctions de check** (qques erreurs repérées) **!**

-   Vérifier les checks pour tous les arguments (j'ai repéré qu'il en manque, notamment pour les arguments ajoutés dernièrement ou pour type dans `central_group`).
