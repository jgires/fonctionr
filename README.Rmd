...
Pour comprendre plus en profondeur notre package et toutes ses possibilités, nous renvoyons l'utilisateur au [Manuel d'utilisation](https://jgires.github.io/fonctionr/articles/fonctionr_functions.html) qui constitue un manuel décrivant dans le détail les différentes fonctions de `fonctionr`.
:::
