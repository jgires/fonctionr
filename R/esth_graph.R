...
#' @param xlab X label on the graphic. As [ggplot2::coord_flip()] is used in the graphic, `xlab` refers to the x label on the graphic, after the [ggplot2::coord_flip()], and not to var in `tab`.
#' @param ylab Y label on the graphic. As [ggplot2::coord_flip()] is used in the graphic, `ylab` refers to the y label on the graphic, after the [ggplot2::coord_flip()], and not to value in `tab`.
