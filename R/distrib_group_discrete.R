...
#' @param reorder `TRUE` if you want to reorder the groups according to the proportion of the first level of `quali_var`. `NA` group, if `na.rm.group = FALSE`, is not included in the reorder. In case of facets, the groups are reordered based on each median group. Default is `FALSE`.
